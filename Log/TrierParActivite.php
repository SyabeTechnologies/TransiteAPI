<?php
    ...
    $sql= "SELECT log.DateEvenement as dateevent, log.HeureEvenement as heure, log.MessageEvenement as message, log.AdresseIP as IP, agence.Nom as nomAgence,  user.Nom as nomUser, log.Type as type, activite.Libelle as libelle
            FROM log
